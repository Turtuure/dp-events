...
final class EventProposalStatsTest extends MigrationTestCase
{
    ...
    private function insertProposal(
        ...
        // event_date is required NOT NULL â€” pick "tomorrow" arbitrarily.
